...
public class ListenableFutureDemo {
  ...
  public static void parallel() {
    ...
    ListenableFuture<Object> taskFuture4 = service.submit(new Task4());
    ...
    Futures.addCallback(taskFuture4, new FutureCallback<Object>() {
      ...
      public void onFailure(Throwable t) {
        System.out.println("onFailure t : " + t.getMessage());
      }
    });
    System.out.println("parallel last statment: " + (System.currentTimeMillis() - start));
...
//    synchronous();
  ...
  public static class Task4 implements Callable<Object> {
